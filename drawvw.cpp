...
// new
	...
	{
		m_cfObjectDescriptor = (CLIPFORMAT)::RegisterClipboardFormat(
...
DROPEFFECT CDrawView::OnDragOver(COleDataObject* /*pDataObject*/,
	DWORD grfKeyState, CPoint point)
{
